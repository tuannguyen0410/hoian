...
<h3 class="page-title">
	<?=@_comments?> <small><?=@_create_edit?> <?=@_comments?></small>
</h3>
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?=PATH_URL?>acp/comments"><?=@_comments?></a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
...
<div class="panel-body">
	<form id="frm_submit" method="post" action="<?=PATH_URL?>acp/comments/save" class="form-horizontal" enctype="multipart/form-data">
				...
				<div class="tabbable-custom ">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab_1_1">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label"><?=@_email?></label>
								<div class="col-sm-10">
									<input type="text" class="form-control" autocomplete="off" id="email" name="email" value="<?php if(!empty($result)) echo stripslashes($result->email);?>" placeholder="<?=@_email?>">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="order_by" class="col-sm-2 control-label"><?=@_created?></label>
								<div class="col-sm-5">
									<p class="form-control-static">
										<b><?php if(!empty($result)) echo date("d M Y H:i a", $result->created)?></b>
									</p>
								</div>
							</div>
							<div class="form-group">
