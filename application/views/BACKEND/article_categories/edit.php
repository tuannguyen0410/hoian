...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?=PATH_URL?>acp/article/categories"><?=@_category?></a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
...
<div class="panel-body">
	<form id="frm_submit" method="post" action="<?=PATH_URL?>acp/article/categories/save" class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="col-md-9 col-sm-9">
					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="tab_1_2">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label"><?=@_slug?></label>
								<div class="col-sm-10">
									<input type="text" class="form-control" onchange="checkLinks(this.value,'')" id="links_en" readonly name="links_en" value="<?php if(!empty($result)) echo str_replace("en/","",$result->links_en)?>" placeholder="<?=@_slug?>">
								</div>
							</div>
						</div>
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						...
						<button type="button" onclick="return location.href='<?=PATH_URL?>acp/article/categories'" class="btn btn-info"><i class="fa fa-ban"></i> <?=@_cancel?></button>
					</div>
				</div>
			</div>
...
<script>
    ...
    function checkLinks(name,lang){
      ...
      $.post("<?=PATH_URL?>acp/article/categories/checkLinks",{links:links,lang:lang,id:$("#id").val()},function(data){var json = JSON.parse(data); $("#links"+lang).val(json.links); $("#order_by").val(json.order_by)});
    }
